...
var A11y = function A11y(_ref) {
  var children = _ref.children,
      ...
      props = _objectWithoutPropertiesLoose(_ref, ["children", "description", "activationMsg", "deactivationMsg", "tabIndex", "href", "role", "showAltText", "actionCall", "focusCall", "disabled", "debug", "a11yElStyle", "startPressed", "hidden"]);

  var constHiddenButScreenreadable = Object.assign({
    opacity: debug ? 1 : 0,
    borderRadius: '50%',
    width: '50px',
    height: '50px',
  ...
  var HtmlAccessibleElement = React__default.useMemo(returnHtmlA11yEl, [description, a11yState, hidden, tabIndex, href, disabled, startPressed, actionCall, focusCall]);
  var AltText = null;
